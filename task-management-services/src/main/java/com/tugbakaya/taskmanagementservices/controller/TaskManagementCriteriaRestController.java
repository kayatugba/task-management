...
@RestController
@RequestMapping("/task-management/criteria")
public class TaskManagementCriteriaRestController {
	...
	/*
	 * @PostMapping(path = "/task/save") public ResponseEntity<TaskEntity>
	 * saveTask(@RequestBody TaskEntity taskEntity) { return new
	 * ResponseEntity<TaskEntity>(taskService.saveTask(taskEntity), HttpStatus.OK);
	 * }
	 */
	...
	/*
	 * @PostMapping(path = "/user/save") public ResponseEntity<UserEntity>
	 * saveUser(@RequestBody UserEntity userEntity) { return new
	 * ResponseEntity<UserEntity>(userService.saveUser(userEntity), HttpStatus.OK);
	 * }
	 */
